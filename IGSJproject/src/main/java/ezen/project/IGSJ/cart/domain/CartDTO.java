...
public class CartDTO {
	...
	public CartDTO(){}
	public CartDTO
	(String cartNum, String userId, String pno, int productCnt, String size)
	{
	...
	public int    getProductCnt()                      {return productCnt;}
	public void   setProductCnt(int productCnt)        {this.productCnt = productCnt;}
